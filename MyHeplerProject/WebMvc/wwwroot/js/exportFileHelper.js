...
//file:文件数据base64
//fileName:文件名称
//fileType:文件类型，如Excel是"application/vnd.ms-excel"
exportFileByBlob = function (file, fileName, fileType) {
    var blob = base64toBlob(file, { type: fileType });
